...
export default function SectionDetail({navigation, route}) {
  ...
  const getMainNumbers = $ => {
    const mainValues = $('.new-section-detail-title ');
    const mainValues1 = $('.new-section-detail-explanation ');
    const mainValues2 = $('.new-section-detail-date ');
        ...
        <ScrollView
          ...
          <View>
            ...
            <View style={{alignItems: 'flex-end', margin: 20}}>
              <Text style={{color: 'grey'}}>{mainNumbers?.date}</Text>
            </View>
          </View>
        </ScrollView>
      </View>
